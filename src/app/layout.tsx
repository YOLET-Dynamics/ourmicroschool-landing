...
// SEO Enhancement: Define metadataBase for canonical URLs
const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://ourmicroschool.com"; // Using a more realistic placeholder
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "OMS - Homeschooling OSS | The Operating System for Your Homeschooling Hub",
    description: "Simplify your homeschooling journey with OMS - Homeschooling OSS. Connect parents, teachers, and students on one powerful platform.",
  ...
  twitter: {
    ...
    description: "Personalized learning, curriculum tools, and progress tracking. Discover the future of homeschooling with OMS - Homeschooling OSS.",

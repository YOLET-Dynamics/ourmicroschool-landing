          ...
          <Card className="bg-card text-card-foreground border border-border shadow-2xl p-10 md:p-16 relative">
            <div className="relative">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <Button
                  type="submit"
                  className="w-full bg-primary hover:bg-primary/90 text-sm md:text-lg py-5 md:py-6 font-semibold transition-all duration-300 hover:shadow-xl md:hover:scale-[1.02] rounded-2xl flex items-center justify-center gap-2"
                >
